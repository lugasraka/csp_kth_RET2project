...
A_helio=120;    %Area of one heliostat, similar to project description data

TES_diameter=30.07;  %diameter of TES
D_receiver=16;       %Receiver diameter
A_total=13.4e6 ;    %This v" "first 5.1e6
...
A_inner=(A_TES+A_Powerblock+A_Tower)*10;   %Source from real layout
