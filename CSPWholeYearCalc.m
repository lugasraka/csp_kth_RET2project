...
h_tower=170;    %height of tower
h_helio=12;     %height of heliostats
A_helio=165;    %Area of one heliostat, similar to project description data

TES_diameter=30.07;  %diameter of TES
D_receiver=16;       %Receiver diameter
A_total=5.1*1e6 ;    %This v"
...
Q_field_GWh=Q_field*1e-9;
%N_heliostat=A_total_mirror/A_helio;
                                                                        
fprintf(' Q Thermal Solar_field in GWh/ year = %f',Q_field_GWh);
